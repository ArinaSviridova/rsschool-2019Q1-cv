1. Arina Sviridova
2. +375291077099, vk.com/naivecoon, Viber/WhatsUp/Telegramm - +375291077099
...
4. HTML, CSS, JS, Local Provisioning, GitHub, Web Storm, Visual Studio  (например: языки программирования, фреймворки, методологии, системы контроля версий, тулы...)
